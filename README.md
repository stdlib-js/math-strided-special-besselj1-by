...
```javascript
besselj1By = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-besselj1-by@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-besselj1-by@umd/bundle.js"></script>
```
